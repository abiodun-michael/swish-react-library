...
var HttpProvider = function (_a) {
    ...
    return (React.createElement(HttpContext.Provider, { value: { instance: instance, networkStatus: isOnline ? 'online' : 'offline' } },
        React.createElement("p", null, "Hello to the world"),
        children));
};
